package com.dudek.dicodingstory.database.mediator
...
class StoriesRemoteMediator(
...
) : RemoteMediator<Int, StoriesResponseItem>() {
    ...
    override suspend fun load(
        ...
        try {
            ...
            val responseData = apiService.getPageStories("Bearer $token", page, state.config.pageSize)
            ...
            database.withTransaction {
                ...
                database.storiesDao().insertStory(responseData.listStory)
            }
